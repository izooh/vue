...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('display')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Complains</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('display_unreviewed')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Review</p>
                </a>
              </li>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('lead_page')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Leads allocation</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link active">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">Blockchain</a>.</strong> 
  </footer>
</div>
<!-- ./wrapper -->
